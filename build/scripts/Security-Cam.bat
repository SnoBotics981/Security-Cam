...
set CLASSPATH=%APP_HOME%\lib\SecurityCamera.jar;%APP_HOME%\lib\NetworkTables-3.1.7-arm-raspbian.jar;%APP_HOME%\lib\cscore-1.0.2-arm-raspbian.jar;%APP_HOME%\lib\opencv-java-3.1.0.jar;%APP_HOME%\lib\commons-io-2.6.jar;%APP_HOME%\lib\json-20180130.jar;%APP_HOME%\lib\mbassador-1.3.2.jar;%APP_HOME%\lib\jade4j-1.2.7.jar;%APP_HOME%\lib\wpilibj-java-2018.4.1.jar;%APP_HOME%\lib\wpiutil-java-3.424242.1.0-20180210063715.jar;%APP_HOME%\lib\ntcore-java-4.424242.0.0-20180214041758.jar;%APP_HOME%\lib\javax.el-api-3.0.1-b04.jar;%APP_HOME%\lib\juel-impl-2.2.7.jar;%APP_HOME%\lib\juel-spi-2.2.7.jar;%APP_HOME%\lib\commons-jexl-2.1.1.jar;%APP_HOME%\lib\commons-collections-3.2.2.jar;%APP_HOME%\lib\commons-lang3-3.4.jar;%APP_HOME%\lib\concurrentlinkedhashmap-lru-1.4.2.jar;%APP_HOME%\lib\pegdown-1.6.0.jar;%APP_HOME%\lib\commons-logging-1.1.1.jar;%APP_HOME%\lib\parboiled-java-1.1.7.jar;%APP_HOME%\lib\parboiled-core-1.1.7.jar;%APP_HOME%\lib\asm-5.0.3.jar;%APP_HOME%\lib\asm-tree-5.0.3.jar;%APP_HOME%\lib\asm-analysis-5.0.3.jar;%APP_HOME%\lib\asm-util-5.0.3.jar
